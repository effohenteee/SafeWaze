...
class Ui_SignUpDialog(object):
    def setupUi(self, SignUpDialog):
        ...
        self.lable_username = QtWidgets.QLabel(SignUpDialog)
        self.lable_username.setObjectName("lable_username")
        self.verticalLayout.addWidget(self.lable_username)
    ...
    def retranslateUi(self, SignUpDialog):
        ...
        self.lable_username.setText(_translate("SignUpDialog", "Username"))
